...
---
+ Create a root project directory named `my_java_mvn_project` and `cd my_java_mvn_project`.
    ...
    └── src
        └── main
            └── java
                └── hello
    ```
+ Within the `src/main/java/hello` directory, you can create any Java classes you want. To maintain consistency with the rest of this guide, create these two classes: `MyHelloWorld.java` and `Learner.java`.
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <artifactId>my-java-maven</artifactId>
                        ...
                        <configuration>
                            <transformers>
                                <transformer
                                    ...
                                    <mainClass>hello.MyHelloWorld</mainClass>
                                </transformer>
                            </transformers>
                        </configuration>
                    </execution>
